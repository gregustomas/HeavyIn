...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: "publish" | "add" | "auth" | "secondary" | "clear" | "addExercise";
  icon?: LucideIcon;
...
const Button = ({
  ...
  const styles = {
    ...
    clear: "flex text-heavy-teal gap-2 cursor-pointer",
    ...
    addExercise: "w-full py-4 bg-heavy-card border-2 border-dashed border-heavy-border hover:border-heavy-teal/50 hover:bg-heavy-teal/5 transition-all rounded-2xl flex items-center justify-center gap-2 group",
    secondary:
