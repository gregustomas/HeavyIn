...
export async function generateMetadata({
  ...
  const baseUrl =
    process.env.NEXT_PUBLIC_BASE_URL || "https://heavy-in.vercel.app";
  const image = data?.image || `${baseUrl}/cbum.avif`;
  ...
  return {
    ...
    openGraph: {
      title: `${data?.title || "Workout"} | HeavyIn`,
      description:
        data?.description || "Check out this training plan on HeavyIn",
...
async function WorkoutDetailPage({ params }: PageProps) {
  ...
  return (
    <main className="page-container p-0">
